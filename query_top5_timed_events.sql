...
FROM
stats$system_event NATURAL JOIN v$event_name
WHERE
...
snap_time,
event,
(snap_time - LAG (snap_time) OVER (PARTITION BY startup_time, event ORDER BY snap_id)) * 86400 AS snap_time_d,
